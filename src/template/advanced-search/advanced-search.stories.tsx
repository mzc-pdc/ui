...
export const AdvancedSearch: FC<SearchProps> = ({isCheck}) => {
  ...
  return (
    <React.Fragment>
      <Stack sx={{width: `100%`, mt: 2, mb: 1.5}}>
        {!checked &&
          <Divider sx={{borderColor: theme.palette.secondary.main}}/>
        }
        <Collapse in={checked} sx={{backgroundColor: theme.palette.secondary.main, borderRadius: `3px`}}>
      ...
      <Grid container alignItems={'center'}>
        <Grid item xs>
          <Grid container alignItems={'center'}>
            ...
            >
              ...
              <MenuItem size={'medium'} onClick={handleClose}>by most recent</MenuItem>
              <MenuItem size={'medium'} onClick={handleClose}>by update</MenuItem>
            </Menu>
            <Divider flexItem orientation={'vertical'} sx={{my: 0.5, mx: 1.5}}/>
        ...
        <Grid item>
          <IconButton circled><CachedIcon fontSize={'small'}/></IconButton>
        </Grid>
